function Prices() {
    ...
    function calculateTotalFinalPrice(numberOfSeat, passengerType, flightType, basePrice){
        return numberOfSeat * calculateDefaultFinalPrice(basePrice, passengerType, flightType);
